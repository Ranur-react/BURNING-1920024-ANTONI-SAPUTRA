...
char server[]="www.lock.e-lock.site";                        //Domain atau Address WEBSERVER
String host="Host: www.lock.e-lock.site"; 
...
Serial.println("Nilai Measurement: ");
...
void VALIDASIDATA(){
   ...
   String data= client.readString();
      ...
      Serial.println(data);
      Serial.println("panjang cart:");
      Serial.print(data.length());
      Serial.print("----------");
      c= data.substring(156); //Karakter Statis
      c.trim();    
